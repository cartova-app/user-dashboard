...
const Categories = () => {
  ...
  const [sortBy, setSortBy] = useState<'name' | 'createdAt' | 'updatedAt' | undefined>(undefined);
  ...
  const categorySortableFields: Record<string, 'name' | 'createdAt' | 'updatedAt'> = {
    name: 'name',
    createdAt: 'createdAt',
  };
  ...
  return (
    <div className="space-y-6 text-start p-8 w-full">
      ...
      <div className="flex justify-between items-end">
        <PageHeading heading="Categories" description="Manage your store categories." />
      ...
      {/* Create / Edit Modal */}
      <CategoryFormModal open={formOpen} onOpenChange={setFormOpen} category={editCategory} />

      {/* Delete Dialog */}
      <DeleteCategoryDialog category={deleteCategory} open={deleteOpen} onOpenChange={setDeleteOpen} />
    </div>
  );
};
