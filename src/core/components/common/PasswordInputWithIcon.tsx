...
interface PasswordInputWithIconProps extends Omit<InputHTMLAttributes<HTMLInputElement>, 'type'> {
  label?: string;
  id?: string;
  placeholder?: string;
  className?: string;
...
export const PasswordInputWithIcon = forwardRef<HTMLInputElement, PasswordInputWithIconProps>(
  function PasswordInputWithIcon(
    { label, id, placeholder = '', className = '', required = false, error = '', ...props },
    ref,
  ) {
