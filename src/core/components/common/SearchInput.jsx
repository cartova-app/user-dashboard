...
import { cn } from '@core/lib/utils'; // Optional utility for className merging
...
const SearchInput = forwardRef(({
    ...
    const variantClasses = {
        default: 'border border-gray-300 bg-white hover:border-gray-400 focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20',
        ghost: 'border border-transparent bg-transparent hover:bg-gray-100 focus:bg-white focus:border-gray-300',
        filled: 'border border-transparent bg-gray-100 hover:bg-gray-200 focus:bg-white focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20',
    };
